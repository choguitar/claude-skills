...
def styles_xml():
    ...
    return (
        ...
        '<w:style w:type="paragraph" w:customStyle="1" w:styleId="SongTitle"><w:name w:val="악보 제목"/><w:basedOn w:val="SheetBase"/><w:next w:val="SongInfo"/><w:qFormat/><w:pPr><w:keepNext/></w:pPr><w:rPr><w:b/><w:bCs/><w:spacing w:val="0"/><w:sz w:val="24"/><w:szCs w:val="28"/></w:rPr></w:style>'
